...
export const ColorMapping: Map<BaseColors, Record<BaseColorPrefixes, string>> = new Map([
  ['slate',   { text: 'text-slate-600 dark:text-slate-500',     bg: 'bg-slate-600 dark:bg-slate-500',     border: 'border-slate-600 dark:border-slate-500'      }],
  ['gray',    { text: 'text-gray-600 dark:text-gray-500',       bg: 'bg-gray-600 dark:bg-gray-500',       border: 'border-gray-600 dark:border-gray-500'        }],
  ['zinc',    { text: 'text-zinc-600 dark:text-zinc-500',       bg: 'bg-zinc-600 dark:bg-zinc-500',       border: 'border-zinc-600 dark:border-zinc-500'        }],
  ['neutral', { text: 'text-neutral-600 dark:text-neutral-500', bg: 'bg-neutral-600 dark:bg-neutral-500', border: 'border-neutral-600 dark:border-neutral-500'  }],
  ['stone',   { text: 'text-stone-600 dark:text-stone-500',     bg: 'bg-stone-600 dark:bg-stone-500',     border: 'border-stone-600 dark:border-stone-500'      }],
  ['red',     { text: 'text-red-600 dark:text-red-800',         bg: 'bg-red-600 dark:bg-red-800',         border: 'border-red-600 dark:border-red-800'          }],
  ['orange',  { text: 'text-orange-600 dark:text-orange-800',   bg: 'bg-orange-600 dark:bg-orange-800',   border: 'border-orange-600 dark:border-orange-800'    }],
  ['amber',   { text: 'text-amber-600 dark:text-amber-800',     bg: 'bg-amber-600 dark:bg-amber-800',     border: 'border-amber-600 dark:border-amber-800'      }],
  ['yellow',  { text: 'text-yellow-600 dark:text-yellow-800',   bg: 'bg-yellow-600 dark:bg-yellow-800',   border: 'border-yellow-600 dark:border-yellow-800'    }],
  ['lime',    { text: 'text-lime-600 dark:text-lime-800',       bg: 'bg-lime-600 dark:bg-lime-800',       border: 'border-lime-600 dark:border-lime-800'        }],
  ['green',   { text: 'text-green-600 dark:text-green-800',     bg: 'bg-green-600 dark:bg-green-800',     border: 'border-green-600 dark:border-green-800'      }],
  ['emerald', { text: 'text-emerald-600 dark:text-emerald-800', bg: 'bg-emerald-600 dark:bg-emerald-800', border: 'border-emerald-600 dark:border-emerald-800'  }],
  ['teal',    { text: 'text-teal-600 dark:text-teal-800',       bg: 'bg-teal-600 dark:bg-teal-800',       border: 'border-teal-600 dark:border-teal-800'        }],
  ['cyan',    { text: 'text-cyan-600 dark:text-cyan-800',       bg: 'bg-cyan-600 dark:bg-cyan-800',       border: 'border-cyan-600 dark:border-cyan-800'        }],
  ['sky',     { text: 'text-sky-600 dark:text-sky-800',         bg: 'bg-sky-600 dark:bg-sky-800',         border: 'border-sky-600 dark:border-sky-800'          }],
  ['blue',    { text: 'text-blue-600 dark:text-blue-800',       bg: 'bg-blue-600 dark:bg-blue-800',       border: 'border-blue-600 dark:border-blue-800'        }],
  ['indigo',  { text: 'text-indigo-600 dark:text-indigo-800',   bg: 'bg-indigo-600 dark:bg-indigo-800',   border: 'border-indigo-600 dark:border-indigo-800'    }],
  ['violet',  { text: 'text-violet-600 dark:text-violet-800',   bg: 'bg-violet-600 dark:bg-violet-800',   border: 'border-violet-600 dark:border-violet-800'    }],
  ['purple',  { text: 'text-purple-600 dark:text-purple-800',   bg: 'bg-purple-600 dark:bg-purple-800',   border: 'border-purple-600 dark:border-purple-800'    }],
  ['fuchsia', { text: 'text-fuchsia-600 dark:text-fuchsia-800', bg: 'bg-fuchsia-600 dark:bg-fuchsia-800', border: 'border-fuchsia-600 dark:border-fuchsia-800'  }],
  ['pink',    { text: 'text-pink-600 dark:text-pink-800',       bg: 'bg-pink-600 dark:bg-pink-800',       border: 'border-pink-600 dark:border-pink-800'        }],
  ['rose',    { text: 'text-rose-600 dark:text-rose-800',       bg: 'bg-rose-600 dark:bg-rose-800',       border: 'border-rose-600 dark:border-rose-800'        }],
]);
