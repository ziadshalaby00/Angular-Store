...
export class Zspinner {
  ...
  bgColor = computed<string | undefined>(() => {
    return colorMapping.get(this.color())?.bg
  })

  borderColor = computed<string | undefined>(() => {
    return colorMapping.get(this.color())?.border
  })

  textColor = computed<string | undefined>(() => {
    return colorMapping.get(this.color())?.text
  })
}
